import modelsData from "@/data/openai/models.json";
import riskAssessmentsData from "@/data/openai/risk-assessments.json";
import eventsData from "@/data/openai/events.json";
import sourcesData from "@/data/openai/sources.json";
import type {
  ModelsData,
  RiskAssessmentsData,
  EventsData,
