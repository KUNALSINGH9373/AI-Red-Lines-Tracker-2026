import modelsData from "@/data/anthropic/models.json";
import riskAssessmentsData from "@/data/anthropic/risk-assessments.json";
import eventsData from "@/data/anthropic/events.json";
import sourcesData from "@/data/anthropic/sources.json";
import type {
  ModelsData,
  RiskAssessmentsData,
  EventsData,
